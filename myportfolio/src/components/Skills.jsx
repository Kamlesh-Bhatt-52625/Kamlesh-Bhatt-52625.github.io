      ...
      <div></div>
        <p data-aos="fade-up">Here are a few Technologies I’ve been working with recently:</p>
          <ul data-aos="fade-up"  className="skills-list">
            ...
            <li className="skills-card">
              <div className="skills-card-name" ><BiCodeAlt className="skills-card-img" fontSize={'27px'} color="rgb(21, 246, 73)"/> DSA</div>
            </li>
            <li className="skills-card">
              <div className="skills-card-name" ><TbBrandCpp className="skills-card-img" color="rgb(21, 246, 73)"/> C++</div>
            </li>
          </ul>
